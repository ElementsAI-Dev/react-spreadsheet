...
describe("<Spreadsheet />", () => {
  ...
  test("switching createFormulaParser", () => {
    // Use data with formula cells to ensure createFormulaParser is called
    const dataWithFormulas = [[{ value: 1 }, { value: "=A1" }]];
    ...
    // createFormulaParser1 should be called at least once during initial render
    expect(createFormulaParser1).toHaveBeenCalled();
    expect(createFormulaParser1).toHaveBeenCalledWith(dataWithFormulas);
    // createFormulaParser2 should be called after switching
    expect(createFormulaParser2).toHaveBeenCalled();
    expect(createFormulaParser2).toHaveBeenCalledWith(dataWithFormulas);
  });
